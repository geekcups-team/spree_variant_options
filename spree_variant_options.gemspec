...
Gem::Specification.new do |s|
  ...
  # Runtime
  s.add_dependency('spree_core', '~> 2.3.x')
  s.add_dependency('spree_api', '~> 2.3.x')
  s.add_dependency('spree_frontend', '~> 2.3.x')
  s.add_dependency('spree_backend',  '~> 2.3.x')

  # Development
  s.add_development_dependency('spree_sample',     '~> 2.3.x')
